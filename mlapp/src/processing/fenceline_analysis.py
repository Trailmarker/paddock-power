...
#------------------------------------------------------------------------------------------------------------------------------------            
        ...
        outputs['SplittingFenceline'] = processing.run('native:densifygeometriesgivenaninterval', alg_params, context=context, is_child_algorithm=True)
...
#------------------------------------------------------------------------------------------------------------------------------------            
        ...
        alg_params = {
             ...
             {'expression':  'round(zcoord,2)', 'length' : 0, 'name': 'Elevation (m)', 'precision': 0, 'type': 6},
