...
class FencelineAnalysis(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterVectorDestination(
                self.MinMax,
                'Fenceline Minimum & Maximum Elevation Coordinates'
            )
        )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        minMaxFile = self.parameterAsOutputLayer(
            parameters, self.MinMax, context)
        outputs = {}
...
# ------------------------------------------------------------------------------------------------------------------------------------
        ...
        outputs['WarpReproject'] = processing.run(
            'gdal:warpreproject', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['ReprojectLayer'] = processing.run(
            'native:reprojectlayer', alg_params, context=context, is_child_algorithm=True)
        ...
        alg_params = {
            'FIELDS_MAPPING': [{'expression': '$id', 'length': 0, 'name': 'ID', 'precision': 0, 'type': 2},
                               {'expression': ' round(angle_at_vertex( $geometry,0),6)',
                                'length': 10, 'name': 'Bearing (°)', 'precision': 3, 'type': 6},
                               {'expression': 'round(x(transform(start_point($geometry),\'EPSG:7845\', \'EPSG:4326\')), 6)',
                                'length': 10, 'name': 'Start Coordinates Long', 'precision': 3, 'type': 6},
                               {'expression': 'round(y(transform(start_point($geometry), \'EPSG:7845\', \'EPSG:4326\')), 6)',
                                'length': 10, 'name': 'Start Coordinates Lat', 'precision': 3, 'type': 6},
                               {'expression': 'round(x(transform(end_point($geometry ), \'EPSG:7845\', \'EPSG:4326\')), 6)',
                                'length': 10, 'name': 'End Coordinates Long', 'precision': 3, 'type': 6},
                               {'expression': 'round(y(transform(end_point($geometry ), \'EPSG:7845\', \'EPSG:4326\')), 6)',
                                'length': 10, 'name': 'End Coordinates Lat', 'precision': 3, 'type': 6},
                               {'expression': '$length', 'length': 10,
                                'name': 'LengthM', 'precision': 2, 'type': 6},
        ...
        outputs['RefactorFields'] = processing.run(
            'qgis:refactorfields', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['SplittingFenceline'] = processing.run(
            'native:densifygeometriesgivenaninterval', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['ExtractElevation'] = processing.run(
            'native:setzfromraster', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['Calculate3dLines'] = processing.run(
        ...
        outputs['SumDistance'] = processing.run(
            'qgis:fieldcalculator', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['JoiningLines'] = processing.run(
            'native:dissolve', alg_params, context=context, is_child_algorithm=True)
        ...
        outputs['SortFields'] = processing.run(
            "native:orderbyexpression", alg_params, context=context, is_child_algorithm=True)
        ...
        alg_params = {
            'FIELDS_MAPPING': [{'expression': 'ID', 'length': 0, 'name': 'ID', 'precision': 0, 'type': 2},
                               {'expression': '"Bearing (°)"', 'length': 10,
                                'name': 'Bearing (°)', 'precision': 3, 'type': 6},
                               {'expression': '"Start Coordinates Long"', 'length': 10,
                                   'name': 'Start Coordinates Long', 'precision': 3, 'type': 6},
                               {'expression': '"Start Coordinates Lat"', 'length': 10,
                                'name': 'Start Coordinates Lat', 'precision': 3, 'type': 6},
                               {'expression': '"End Coordinates Long"', 'length': 10,
                                'name': 'End Coordinates Long', 'precision': 3, 'type': 6},
                               {'expression': '"End Coordinates Lat"', 'length': 10,
                                'name': 'End Coordinates Lat', 'precision': 3, 'type': 6},
                               {'expression': 'round(LengthM,2)', 'length': 10,
                                'name': 'Distance as crow flies (m)', 'precision': 2, 'type': 6},
                               {'expression': 'round(LengthKM,2)', 'length': 10,
                                'name': 'Distance as crow flies (km)', 'precision': 2, 'type': 6},
                               #{'expression': '"Distance"', 'length': 10, 'name': 'Distance', 'precision': 2, 'type': 6},
                               {'expression': 'round(TotalDistanceM,2)', 'length': 10,
                                'name': 'Distance inc. terrain (m)', 'precision': 2, 'type': 6},
                               {'expression': 'round(TotalDistanceM / 1000,2)', 'length': 10,
                                'name': 'Distance inc. terrain (km)', 'precision': 2, 'type': 6},
                               {'expression': 'abs(round( "TotalDistanceM" -  "LengthM" ,2))',
                                'length': 10, 'name': 'Difference (m)', 'precision': 2, 'type': 6},
                               {'expression': 'round(MinimumElev,1)', 'length': 0,
                                'name': 'Minimum Elevation', 'precision': 0, 'type': 6},
                               {'expression': 'round(MaximumElev,1)', 'length': 0, 'name': 'Maximum Elevation', 'precision': 0, 'type': 6}],
            'INPUT': outputs['SortFields']['OUTPUT'],
            'OUTPUT': outputFile
        }
        fenceline_analysis = processing.run(
...
# ------------------------------------------------------------------------------------------------------------------------------------
        ...
        outputs['DeleteDuplicateVertices'] = processing.run(
            'qgis:deleteduplicategeometries', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        outputs['AddGeometryAtt'] = processing.run(
        ...
        outputs['ExtractMinimumElevation'] = processing.run(
        ...
        outputs['ExtractMaximumElevation'] = processing.run(
            'native:extractbyexpression', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        outputs['MergeMinMax'] = processing.run(
        ...
        alg_params = {
            'FIELDS_MAPPING': [{'expression': 'ID', 'length': 0, 'name': 'Line ID', 'precision': 0, 'type': 2},
                               ...
                               {'expression':  'round(zcoord,2)', 'length': 0,
        ...
        results = {self.OUTPUT: fenceline_analysis, self.MinMax: MinMaxMerge}
        return results
