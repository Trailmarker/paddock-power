...
Latitude = CalculatedField(propertyName="LATITUDE", name=LATITUDE, defaultValue=float('NaN'), dps=2)
Length = CalculatedField(propertyName="LENGTH", name=LENGTH, dps=2)
Longitude = CalculatedField(propertyName="LONGITUDE", name=LONGITUDE, defaultValue=float('NaN'), dps=2)
