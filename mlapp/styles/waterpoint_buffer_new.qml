...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyAlgorithm="0" version="3.22.8-Białowieża" symbologyReferenceScale="-1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" referencescale="-1" enableorderby="0" attr="Buffer Distance (km)" symbollevels="0">
    <categories>
      <category label="8km buffer" symbol="0" value="8" render="true"/>
    </categories>
    <symbols>
      <symbol force_rhr="0" type="fill" clip_to_extent="1" alpha="1" name="0">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option value="44,123,182,255" type="QString" name="line_color"/>
    ...
    <source-symbol>
      <symbol force_rhr="0" type="fill" clip_to_extent="1" alpha="1" name="0">
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol force_rhr="0" type="line" clip_to_extent="1" alpha="1" name="@0@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
    ...
    <colorramp type="colorbrewer" name="[source]">
      <Option type="Map">
        <Option value="4" type="QString" name="colors"/>
        <Option value="0" type="QString" name="inverted"/>
        <Option value="colorbrewer" type="QString" name="rampType"/>
        <Option value="RdYlBu" type="QString" name="schemeName"/>
      </Option>
      <prop k="colors" v="4"/>
      <prop k="inverted" v="0"/>
      <prop k="rampType" v="colorbrewer"/>
      <prop k="schemeName" v="RdYlBu"/>
    </colorramp>
    <rotation/>
    <sizescale/>
    <orderby>
      <orderByClause asc="1" nullsFirst="0">"WA_DISTKM"</orderByClause>
    </orderby>
  </renderer-v2>
  <customproperties>
    <Option type="Map">
      <Option value="CURR_WAREAKM2" type="QString" name="dualview/previewExpressions"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Buffer Distance (km)">
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="Paddock Area (km²)"/>
    <default applyOnUpdate="0" expression="" field="Buffer Distance (km)"/>
    <default applyOnUpdate="0" expression="" field="Current Watered Area (km²)"/>
    <default applyOnUpdate="0" expression="" field="Date Created"/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" field="Buffer Distance (km)" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Current Watered Area (km²)" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Date Created" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="fid" desc=""/>
    <constraint exp="" field="Paddock Name" desc=""/>
    <constraint exp="" field="Paddock Area (km²)" desc=""/>
    <constraint exp="" field="Buffer Distance (km)" desc=""/>
    <constraint exp="" field="Current Watered Area (km²)" desc=""/>
    <constraint exp="" field="Date Created" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="Paddock Area (km²)"/>
      <column width="-1" type="field" hidden="0" name="Buffer Distance (km)"/>
      <column width="-1" type="field" hidden="0" name="Current Watered Area (km²)"/>
      <column width="-1" type="field" hidden="0" name="Date Created"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="Buffer Distance (km)"/>
    <field editable="1" name="CURR_WAREAKM2"/>
    <field editable="1" name="Current Watered Area (km²)"/>
    ...
    <field editable="1" name="WA_DISTKM"/>
    <field editable="1" name="fid"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="Buffer Distance (km)"/>
    <field labelOnTop="0" name="CURR_WAREAKM2"/>
    <field labelOnTop="0" name="Current Watered Area (km²)"/>
    ...
    <field labelOnTop="0" name="Paddock Area (km²)"/>
    <field labelOnTop="0" name="Paddock Name"/>
    <field labelOnTop="0" name="WA_DISTKM"/>
    <field labelOnTop="0" name="fid"/>
  </labelOnTop>
  <reuseLastValue/>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>CURR_WAREAKM2</previewExpression>
  <mapTip>&lt;center>&lt;b>[% title( "PDK_NAME") || ' Pdk '  %] &lt;/b>&lt;br>&#xd;
&#xd;
&lt;b>[%"WA_DISTKM" || 'km buffer'%]&lt;/b>&#xd;
[%  '\n'  ||round("CURR_WAREAKM2" ,2) || 'km²' %]&lt;/center></mapTip>
