...
<qgis labelsEnabled="0" version="3.26.2-Buenos Aires" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|AttributeTable" readOnly="0">
  <flags>
  ...
  <renderer-v2 referencescale="-1" type="categorizedSymbol" forceraster="0" attr="Waterpoint Type" symbollevels="0" enableorderby="0">
    <categories>
      <category type="string" symbol="0" label="Bore" render="true" value="Bore"/>
      <category type="string" symbol="1" label="Dam" render="true" value="Dam"/>
      <category type="string" symbol="2" label="Trough" render="true" value="Trough"/>
      <category type="string" symbol="3" label="Turkey Nest" render="true" value="Turkey Nest"/>
      <category type="string" symbol="4" label="Water Tank" render="true" value="Water Tank"/>
      <category type="string" symbol="5" label="Waterhole" render="true" value="Waterhole"/>
    </categories>
    <symbols>
      <symbol name="0" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
      ...
      <symbol name="1" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="2" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="3" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="4" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" class="FontMarker" enabled="1">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="chr" type="QString" value="TK"/>
            <Option name="color" type="QString" value="0,0,0,255"/>
            <Option name="font" type="QString" value="Calibri"/>
            <Option name="font_style" type="QString" value="Bold"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
      ...
      <symbol name="5" type="marker" alpha="1" frame_rate="10" force_rhr="0" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Tank" type="QString" value="Tank"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias name="" field="Waterpoint Type" index="3"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="Waterpoint Type"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="Waterpoint Type" exp_strength="0" unique_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="Waterpoint Type" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="Waterpoint Type" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="Waterpoint Type" showLabel="1" index="3">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" style="" bold="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="Longitude" showLabel="1" index="4">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" style="" bold="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="Latitude" showLabel="1" index="5">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" style="" bold="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField name="Elevation (m)" showLabel="1" index="6">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" style="" bold="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
