...
<qgis readOnly="0" version="3.22.14-Białowieża" labelsEnabled="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|AttributeTable">
      ...
      <symbol clip_to_extent="1" alpha="1" name="0" force_rhr="0" type="line">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="5;3" name="customdash" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="customdash_map_unit_scale" type="QString"/>
            <Option value="MM" name="customdash_unit" type="QString"/>
            <Option value="0" name="dash_pattern_offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Rounded Length (km)">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="Length (km)" name="" index="3"/>
    <alias field="Rounded Length (km)" name="Length (km)" index="4"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" field="Length (km)" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Rounded Length (km)" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="fid"/>
    <constraint desc="" exp="" field="Name"/>
    <constraint desc="" exp="" field="Status"/>
    <constraint desc="" exp="" field="Length (km)"/>
    <constraint desc="" exp="" field="Rounded Length (km)"/>
  </constraintExpressions>
  <expressionfields>
    <field expression="round(&quot;Length (km)&quot;, 2)" precision="0" typeName="" subType="0" name="Rounded Length (km)" length="0" type="6" comment=""/>
    <field expression="round(&quot;Length (km)&quot;, 2)" precision="0" typeName="" subType="0" name="Rounded Length (km)" length="0" type="6" comment=""/>
  </expressionfields>
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column hidden="1" name="Length (km)" width="-1" type="field"/>
      <column hidden="0" name="Rounded Length (km)" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField showLabel="1" name="Date Commisioned" index="-1"/>
    <attributeEditorField showLabel="1" name="Date Decommisioned" index="-1"/>
    <attributeEditorField showLabel="1" name="Length (km)" index="3"/>
  </attributeEditorForm>
  <editable>
    ...
    <field editable="0" name="Rounded Length (km)"/>
  ...
  <labelOnTop>
    ...
    <field name="Rounded Length (km)" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="Rounded Length (km)"/>
