...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyAlgorithm="0" version="3.22.8-Białowieża" symbologyReferenceScale="-1" styleCategories="AllStyleCategories">
      ...
      <symbol force_rhr="0" type="line" clip_to_extent="1" alpha="1" name="0">
        ...
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option value="1.46" type="QString" name="line_width"/>
            <Option value="MM" type="QString" name="line_width_unit"/>
            <Option value="0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option value="'[Please define preview text]'" type="QString" name="dualview/previewExpressions"/>
  ...
  <DiagramLayerSettings zIndex="0" obstacle="0" placement="2" priority="0" linePlacementFlags="18" dist="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Date Commisioned">
    ...
    <field configurationFlags="None" name="Date Decommisioned">
      <editWidget type="DateTime">
        <config>
          <Option type="Map">
            <Option value="true" type="bool" name="allow_null"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="'Proposed'" field="Status"/>
    <default applyOnUpdate="0" expression="if( &quot;Status&quot; = 'Active', to_string(year( now())) || '-01-01', '')" field="Date Commisioned"/>
    <default applyOnUpdate="0" expression="if( &quot;Status&quot; = 'Inactive', to_string(year( now())) || '-01-01', '')" field="Date Decommisioned"/>
    <default applyOnUpdate="1" expression="round($length / 1000, 2)" field="Length (km)"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" constraints="1" field="Status" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Date Commisioned" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Date Decommisioned" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="Length (km)" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="Date Commisioned" desc=""/>
    <constraint exp="" field="Date Decommisioned" desc=""/>
    <constraint exp="" field="Length (km)" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="Date Commisioned"/>
      <column width="-1" type="field" hidden="0" name="Date Decommisioned"/>
      <column width="-1" type="field" hidden="0" name="Length (km)"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField index="2" showLabel="1" name="Status"/>
    <attributeEditorField index="3" showLabel="1" name="Date Commisioned"/>
    <attributeEditorField index="4" showLabel="1" name="Date Decommisioned"/>
    <attributeEditorField index="5" showLabel="1" name="Length (km)"/>
  </attributeEditorForm>
  <editable>
