...
<qgis version="3.22.13-Białowieża" styleCategories="AllStyleCategories" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" maxScale="0" simplifyLocal="1" minScale="0" simplifyMaxScale="1">
      ...
      <symbol clip_to_extent="1" name="0" type="line" force_rhr="0" alpha="1">
        ...
        <layer locked="1" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="line_width" type="QString" value="2.06"/>
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" type="QString" value="0"/>
            <Option name="joinstyle" type="QString" value="round"/>
            <Option name="line_color" type="QString" value="255,96,17,255"/>
            <Option name="line_style" type="QString" value="solid"/>
  ...
  <fieldConfiguration>
    ...
    <field name="Length (km)" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="Build Order" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="Rounded Length (km)" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="Length (km)" index="2" name=""/>
    <alias field="Build Order" index="3" name=""/>
    <alias field="Status" index="4" name=""/>
    <alias field="Rounded Length (km)" index="5" name="Length (km)"/>
  </aliases>
  <defaults>
    <default expression="" field="fid" applyOnUpdate="0"/>
    <default expression="" field="Name" applyOnUpdate="0"/>
    <default expression="" field="Length (km)" applyOnUpdate="0"/>
    <default expression="" field="Build Order" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="Rounded Length (km)" unique_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="fid" desc=""/>
    <constraint exp="" field="Name" desc=""/>
    <constraint exp="" field="Length (km)" desc=""/>
    <constraint exp="" field="Build Order" desc=""/>
    <constraint exp="" field="Status" desc=""/>
    <constraint exp="" field="Rounded Length (km)" desc=""/>
  </constraintExpressions>
  <expressionfields>
    <field comment="" expression="round(&quot;Length (km)&quot;, 2)" typeName="" name="Rounded Length (km)" subType="0" precision="0" type="6" length="0"/>
  </expressionfields>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="1" width="-1" name="Length (km)" type="field"/>
      <column hidden="0" width="-1" name="Build Order" type="field"/>
      <column hidden="0" width="-1" name="Status" type="field"/>
      <column hidden="0" width="-1" name="Rounded Length (km)" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="Build Order"/>
  ...
  <labelOnTop>
    <field name="Build Order" labelOnTop="0"/>
  ...
  <reuseLastValue>
    <field reuseLastValue="0" name="Build Order"/>
