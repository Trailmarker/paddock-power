...
<qgis version="3.26.2-Buenos Aires" labelsEnabled="0" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|AttributeTable">
    ...
    <symbols>
      <symbol frame_rate="10" name="0" clip_to_extent="1" type="fill" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol frame_rate="10" name="@0@0" clip_to_extent="1" type="line" alpha="1" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="Map Unit" index="1"/>
    <alias name="" field="Landscape Class" index="2"/>
    <alias name="" field="Class Description" index="3"/>
    <alias name="" field="Erosion Risk" index="4"/>
    <alias name="" field="AE/km²" index="5"/>
    <alias name="" field="Area (km²)" index="6"/>
    <alias name="" field="Perimeter (km)" index="7"/>
    <alias name="" field="Name" index="8"/>
  </aliases>
  <defaults>
    <default field="fid" expression="" applyOnUpdate="0"/>
    <default field="Map Unit" expression="" applyOnUpdate="0"/>
    <default field="Landscape Class" expression="" applyOnUpdate="0"/>
    <default field="Class Description" expression="" applyOnUpdate="0"/>
    <default field="Erosion Risk" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="Map Unit" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="Landscape Class" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="Class Description" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint field="Erosion Risk" notnull_strength="0" constraints="0" unique_strength="0" exp_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="Map Unit" type="field" hidden="0" width="-1"/>
      <column name="Landscape Class" type="field" hidden="0" width="-1"/>
      <column name="Class Description" type="field" hidden="0" width="-1"/>
      <column name="Erosion Risk" type="field" hidden="0" width="-1"/>
