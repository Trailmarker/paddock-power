...
<qgis version="3.22.13-Białowieża" labelsEnabled="0" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|AttributeTable">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" graduatedMethod="GraduatedColor" referencescale="-1" enableorderby="0" attr="case&#xd;&#xa;when matchCurrentTimeframe(&quot;Timeframe&quot;) then &quot;AE/km²&quot;&#xd;&#xa;else 'Ignored'&#xd;&#xa;end&#xd;&#xa;" type="graduatedSymbol">
    <ranges>
      <range lower="0.000000000000000" upper="0.000000000000000" label="Non-producing" symbol="0" render="true"/>
      <range lower="0.000000000000000" upper="5.000000000000000" label="0 – 5 AE/km²" symbol="1" render="true"/>
      <range lower="5.000000000000000" upper="10.000000000000000" label="5 – 10 AE/km²" symbol="2" render="true"/>
      <range lower="10.000000000000000" upper="15.000000000000000" label="10 – 15 AE/km²" symbol="3" render="true"/>
      <range lower="15.000000000000000" upper="20.000000000000000" label="15 – 20 AE/km²" symbol="4" render="true"/>
      <range lower="20.000000000000000" upper="100.000000000000000" label="Over 20 AE/km²" symbol="5" render="true"/>
    </ranges>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="1" type="fill" alpha="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          ...
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="161,217,155,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
    ...
    <colorramp name="[source]" type="preset">
      ...
      <prop v="161,217,155,255" k="preset_color_0"/>
      <prop v="116,196,118,255" k="preset_color_1"/>
      <prop v="65,171,93,255" k="preset_color_2"/>
      <prop v="35,139,69,255" k="preset_color_3"/>
      <prop v="0,109,44,255" k="preset_color_4"/>
      <prop v="#a1d99b" k="preset_color_name_0"/>
      <prop v="#74c476" k="preset_color_name_1"/>
      <prop v="#41ab5d" k="preset_color_name_2"/>
      <prop v="#238b45" k="preset_color_name_3"/>
      <prop v="#006d2c" k="preset_color_name_4"/>
  ...
  <aliases>
    ...
    <alias field="Area (km²)" name="" index="1"/>
    <alias field="AE/km²" name="" index="2"/>
    <alias field="Potential AE/km²" name="" index="3"/>
    <alias field="AE" name="" index="4"/>
    <alias field="Potential AE" name="" index="5"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="Potential AE/km²"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="Area (km²)" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="AE/km²" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="Potential AE/km²" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="AE" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="Potential AE" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="Potential AE/km²" exp=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" name="Area (km²)" type="field"/>
      <column width="-1" hidden="0" name="AE" type="field"/>
      <column width="-1" hidden="0" name="Potential AE" type="field"/>
      <column width="262" hidden="0" name="Potential AE/km²" type="field"/>
      <column width="-1" hidden="0" name="Timeframe" type="field"/>
