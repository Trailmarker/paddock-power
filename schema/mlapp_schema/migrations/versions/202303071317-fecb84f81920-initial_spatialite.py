...
Revision ID: fecb84f81920
Revises: initial_dummy
Create Date: 2023-03-07 13:17:40.927558
...
revision = 'fecb84f81920'
down_revision = 'initial_dummy'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    # important - hack in an initial revision prior to the usual upgrade
    # op.execute(f"insert into alembic_version (version_num) values ('initial_dummy')")
