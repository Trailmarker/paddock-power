...
#
#        self.addParameter(
#            QgsProcessingParameterString('customlist', 'Custom Buffers in Meters seperated with a comma eg. 5000, 2000', optional=True))
...
#        return results
#        
#        waterpoints_analysis = processing.run('qgis:refactorfields', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
#        return {self.OUTPUT : waterpoint_analysis}
#